...
export const CustomEdge = memo(
  ({
    ...
    // Enhanced edge styling - preserve style prop values, only override if not provided
    const edgeStyle = {
      ...style,
      strokeWidth: style.strokeWidth ?? (animated ? 2 : 1.5),
      stroke: style.stroke ?? (animated ? "#3b82f6" : "#718096"),
      opacity: style.opacity ?? (animated ? 0.9 : 0.7),

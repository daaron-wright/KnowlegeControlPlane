  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        const getTargetPosition = (pos?: string): Position => {
          if (!pos) return Position.Left; // Default for target (incoming edges)
        ...
        const getSourcePosition = (pos?: string): Position => {
          if (!pos) return Position.Right; // Default for source (outgoing edges)
          const normalized = pos.toLowerCase();
          if (normalized === "top") return Position.Top;
          if (normalized === "bottom") return Position.Bottom;
        ...
        const targetPosition = getTargetPosition(data.targetPosition);
        const sourcePosition = getSourcePosition(data.sourcePosition);
